...
import com.p10.cleanharbours.ui.registration.RegistrationActivity
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        loginViewModel.loginResult.observe(this@LoginActivity, Observer {
            ...
            if (loginResult.success != null) {
                ...
                myEdit.putString("username", loginResult.success.displayName)
                myEdit.putString("token", loginResult.success.token)
                myEdit.commit()
